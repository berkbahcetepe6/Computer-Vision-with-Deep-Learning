...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        pool_height = 2
        pool_width = 2
        H_filtered = 1 + (input_dim[1] - pool_height) // 2
        W_filtered = 1 + (input_dim[2] - pool_width) // 2 
        
        self.params['W1'] = weight_scale * np.random.randn(num_filters, input_dim[0], filter_size, filter_size)
        self.params['b1'] = np.zeros(num_filters)
        self.params['W2'] = weight_scale * np.random.randn(H_filtered * W_filtered * num_filters, hidden_dim)
    ...
    def loss(self, X, y=None):
        ...
        dx3, grads["W3"], grads["b3"] = affine_backward(dx, cache3)
        dx2, grads["W2"], grads["b2"] = affine_lrelu_backward(dx3, cache2)
        _, grads["W1"], grads["b1"] = conv_lrelu_pool_backward(dx2, cache1)
